...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<int,int,int>), factory.System_Action_int_int_int);
		dict.Add(typeof(System.Action<int,int,string>), factory.System_Action_int_int_string);
		...
		DelegateTraits<System.Action<int,int,int>>.Init(factory.System_Action_int_int_int);
		DelegateTraits<System.Action<int,int,string>>.Init(factory.System_Action_int_int_string);
		...
		TypeTraits<System.Action<int,int,int>>.Init(factory.Check_System_Action_int_int_int);
		TypeTraits<System.Action<int,int,string>>.Init(factory.Check_System_Action_int_int_string);
		...
		StackTraits<System.Action<int,int,int>>.Push = factory.Push_System_Action_int_int_int;
		StackTraits<System.Action<int,int,string>>.Push = factory.Push_System_Action_int_int_string;
	...
	class System_Action_int_int_int_Event : LuaDelegate
	{
		public System_Action_int_int_int_Event(LuaFunction func) : base(func) { }
		public System_Action_int_int_int_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(int param0, int param1, int param2)
		{
			func.BeginPCall();
			func.Push(param0);
			func.Push(param1);
		...
		public void CallWithSelf(int param0, int param1, int param2)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public System.Action<int,int,int> System_Action_int_int_int(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<int,int,int> fn = delegate(int param0, int param1, int param2) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_int_int_int_Event target = new System_Action_int_int_int_Event(func);
			System.Action<int,int,int> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_int_int_int_Event target = new System_Action_int_int_int_Event(func, self);
			System.Action<int,int,int> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_int_int_int(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<int,int,int>), L, pos);
	}

	void Push_System_Action_int_int_int(IntPtr L, System.Action<int,int,int> o)
	{
		ToLua.Push(L, o);
	}

	class System_Action_int_int_string_Event : LuaDelegate
	{
		public System_Action_int_int_string_Event(LuaFunction func) : base(func) { }
		public System_Action_int_int_string_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public System.Action<int,int,string> System_Action_int_int_string(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<int,int,string> fn = delegate(int param0, int param1, string param2) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_int_int_string_Event target = new System_Action_int_int_string_Event(func);
			System.Action<int,int,string> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_int_int_string_Event target = new System_Action_int_int_string_Event(func, self);
			System.Action<int,int,string> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_int_int_string(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<int,int,string>), L, pos);
	}

	void Push_System_Action_int_int_string(IntPtr L, System.Action<int,int,string> o)
	{
		ToLua.Push(L, o);
	}
