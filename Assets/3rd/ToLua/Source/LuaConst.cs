...
{
    public static string luaDir = Application.dataPath + "/Lua/myLua/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Lua/myLua/ToLua/Lua";        //tolua lua文件目录
    public static string toluaCsDir = Application.dataPath + "/3rd/Tolua/ToLua/Lua";    //tolua C# 逻辑代码

    public static string luaPersistentDataPath
    {
        get
        {
            return LuaFramework.GameWorld.Inst.UpdateManager.getLuaRoot() + "/Lua";
        }
    }
    public static string toluaPersistentDataPath
    {
        get
        {
            return LuaFramework.GameWorld.Inst.UpdateManager.getLuaRoot() + "/ToLua/Lua";
        }
